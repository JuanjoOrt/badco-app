...
import { VIEW_HISTORY, VIEW_HOME_TAB, VIEW_SHOP_TAB, VIEW_SHOPPING_CART } from '../../constants'
  ...
  return (
    <View>
      ...
      <View style={styles.content}>
        <DrawerItem label='Comunicados' icon={<Feather name='home' size={24} />} route={VIEW_HOME_TAB}/>
